    ...
    render() {
        return html`
            <div class="sf-content">
                ...
                <p>Datoer: Festivalen afholdes fra 24. juli til 27. juli 2025.</p>
                <p>Lokation: Adressen er Møllevej 44, Sandved. </p>
                <p>Mad og drikke: Alle deltagere på festivalen deltager efter evne i de praktiske opgaver under festivalen inkl. oprydning og madlavning. Vi laver et skema når tilmeldingerne
    er på plads.</p>
