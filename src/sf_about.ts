    ...
    render() {
        ...
        return html`
            ...
            ${countdownBanner}
                ...
                <p>Efter en fantastisk debut i 2025 gentager vi successen! Dette er andet år festivalen afholdes, og vi glæder os til endnu en omgang med god stemning, musik og fællesskab.</p>
